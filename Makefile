...
C_SOURCES += Lib/lib_vision_models_pp/lib_vision_models_pp/Src/od_pp_yolov8.c
C_SOURCES += Lib/lib_vision_models_pp/lib_vision_models_pp/Src/od_pp_centernet.c
...
C_SOURCES += STM32Cube_FW_N6/Drivers/STM32N6xx_HAL_Driver/Src/stm32n6xx_hal_uart.c
...
C_SOURCES += Lib/Camera_Middleware/cmw_camera.c
C_SOURCES += Lib/Camera_Middleware/cmw_utils.c
...
C_SOURCES += Lib/Camera_Middleware/sensors/imx335/imx335.c
C_SOURCES += Lib/Camera_Middleware/sensors/imx335/imx335_reg.c
C_SOURCES += Lib/Camera_Middleware/sensors/vd6g/vd6g.c
C_SOURCES += Lib/Camera_Middleware/sensors/vd55g1/vd55g1.c
...
C_SOURCES += Lib/Camera_Middleware/ISP_Library/isp/Src/isp_core.c
C_SOURCES += Lib/Camera_Middleware/ISP_Library/isp/Src/isp_services.c
C_SOURCES += Lib/Camera_Middleware/ISP_Library/isp/Src/isp_tool_com.c
C_SOURCES += STM32Cube_FW_N6/Utilities/lcd/stm32_lcd.c
C_SOURCES += Lib/AI_Runtime/Npu/ll_aton/ll_aton.c
C_SOURCES += Lib/AI_Runtime/Npu/ll_aton/ll_aton_rt_main.c
C_SOURCES += Lib/AI_Runtime/Npu/ll_aton/ll_aton_runtime.c
C_SOURCES += Lib/AI_Runtime/Npu/ll_aton/ll_aton_util.c
C_SOURCES += Lib/AI_Runtime/Npu/ll_aton/ll_sw_float.c
C_SOURCES += Lib/AI_Runtime/Npu/ll_aton/ll_sw_integer.c
...
C_DEFS += -DLL_ATON_OSAL=LL_ATON_OSAL_USER_IMPL 
C_DEFS += -DLL_ATON_DBG_BUFFER_INFO_EXCLUDED=1
C_DEFS += -DLL_ATON_RT_MODE=LL_ATON_RT_ASYNC
C_DEFS += -DLL_ATON_SW_FALLBACK
ifeq ($(SENSOR),IMX335)
C_DEFS += -DUSE_IMX335_SENSOR
endif
ifeq ($(SENSOR),VD66GY)
C_DEFS += -DUSE_VD66GY_SENSOR
endif
ifeq ($(SENSOR),OV5640)
C_DEFS += -DUSE_OV5640_SENSOR
endif
ifeq ($(SENSOR),VD55G1)
C_DEFS += -DUSE_VD55G1_SENSOR
endif
ifeq ($(SENSOR),VD1941)
C_DEFS += -DUSE_VD1941_SENSOR
endif
ifeq ($(SENSOR),ALL_SENSORS)
C_DEFS += -DUSE_ALL_SENSORS
endif

# C includes
# Patched files
C_INCLUDES += -ILib/Camera_Middleware
C_INCLUDES += -ILib/Camera_Middleware/sensors
C_INCLUDES += -ILib/Camera_Middleware/sensors/imx335
C_INCLUDES += -ILib/Camera_Middleware/sensors/vd55g1
