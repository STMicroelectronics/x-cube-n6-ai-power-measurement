...
static od_pp_outBuffer_t out_detections[AI_OBJDETECT_ST_SSD_PP_NB_DETECTIONS];
...
int32_t app_postprocess_init(void *params_postprocess)
{
  ...
  ssd_st_pp_static_param_t *params = (ssd_st_pp_static_param_t *) params_postprocess;
	params->nb_classes = AI_OBJDETECT_ST_SSD_PP_NB_CLASSES;
	params->nb_detections = AI_OBJDETECT_ST_SSD_PP_NB_DETECTIONS;
	params->max_boxes_limit = AI_OBJDETECT_ST_SSD_PP_MAX_BOXES_LIMIT;
	params->conf_threshold = AI_OBJDETECT_ST_SSD_PP_CONF_THRESHOLD;
	params->iou_threshold = AI_OBJDETECT_ST_SSD_PP_IOU_THRESHOLD;
...
int32_t app_postprocess_run(void *pInput[], int nb_input, void *pOutput, void *pInput_param)
{
  ...
  error = objdetect_ssd_st_pp_process(&pp_input, pObjDetOutput,
