#ifndef STAI_INTERNAL_H
#define STAI_INTERNAL_H
/**
  ******************************************************************************
  * @file    stai_internal.h
...
#define STAI_SET_ERROR(net_ctx, cond, value, exit) { \
